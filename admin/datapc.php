    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="pull-right">
                    <a href="datapc_tambah.php" class="btn btn-primary"><i class="fa fa-cloud"></i> Upload Arsip</a>
                </div>
            </div>
        </div>
        ...
        <table id="table" class="table table-bordered table-striped table-hover table-datatable">
            ...
            <tbody>
                ...
                include '../koneksi.php';
                $no = 1;
                $arsip = mysqli_query($koneksi, "SELECT * FROM datapc  ORDER BY arsip_id DESC");
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $p['petugas_pemakai'] ?></td>
                        ...
                        <td class="text-center">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="datapc_hapus.php?id=<?php echo $p['arsip_id']; ?>" class="btn btn-primary"><i class="fa fa-check"></i> &nbsp; Ya, hapus</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="btn-group">
                                ...
                                <a target="_blank" href="datapc_preview.php?id=<?php echo $p['arsip_id']; ?>" class="btn btn-default"><i class="fa fa-search"></i> Preview</a>
                                <a href="datapc_edit.php?id=<?php echo $p['arsip_id']; ?>" class="btn btn-default"><i class="fa fa-wrench"></i></a>
