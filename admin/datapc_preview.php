                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Preview Arsip1</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu" style="padding-top: 0px">
                                <li><a href="#">Home</a> <span class="bread-slash">/</span></li>
                                <li><span class="bread-blod">Preview Arsip1</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Preview Arsip1</h3>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Nama Pemakai</th>
                                        <td><?php echo $d['petugas_pemakai']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Prossesor</th>
                                        <td><?php echo $d['prosessor']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>RAM</th>
